...
@
The seven ecoregions in Utah are displayed in Figure~\ref{fig:UTecoregions}.  Ecoregions are used during creation of several of the survey designs described in this vignette.


\begin{figure}
\centering
\includegraphics{Area_Design_plot}
\caption{Location of the seven ecoregions in Utah.}
\label{fig:UTecoregions}
\end{figure}
\newpage
