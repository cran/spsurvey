...
@
Streams in the Luckiamute watershed are displayed in Figure~\ref{fig:LuckAshstreams1} classified by stream type and in Figure~\ref{fig:LuckAshstreams2} classified by Strahler order category.

\begin{figure}
\centering
\includegraphics{Linear_Design_plot1}
\caption{Location of streams in the Luckiamute watershed classified by stream type.}
\label{fig:LuckAshstreams1}
\end{figure}

\begin{figure}
\centering
\includegraphics{Linear_Design_plot2}
\caption{Location of streams in the Luckiamute watershed classified by Strahler order category.}
\label{fig:LuckAshstreams2}
\end{figure}
