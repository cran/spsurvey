...
#'
#' @param pcfactor.ind Lgical value that indicates whether the population
...
#' contains variance estimates, a logical variable named warn,ind, which is the
#' indicator for warning messges, and a data frame named warn.df, which contains
#' warning messages.
#'
