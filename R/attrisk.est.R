...
#'
#' @param xcoord Vector of x-coordinates for location for each site, which is
...
#'
#' @param stratum Vector of the stratum values for each site.  The default is
#'   NULL.
#'
...
#'   support.
#'
#' @param pcfsize The size of the resource, which is required for calculation
...
#'   NULL.
#'
#' @param stage1size The size of the stage one sampling units of a two-stage
...
#'
#' @param swgt1 The stage one size-weight for each site.  The default is NULL.
#'
...
#'   The default is TRUE.
#'
#' @param warn.ind A logical value that indicates whether warning messages were
