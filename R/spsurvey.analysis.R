...
#' package.
#'
#' @param sites Data frame consisting of two variables: the first variable is
...
#'   is NULL.
#'
#' @param design Data frame consisting of design variables.  If variable names
...
#'
#' @param siteID site IDs.  This variable can be input directly or as a
#'   formula and must be supplied either as this argument or in the design data
#'   frame.  The default is NULL.
#'
#' @param wgt Vector of final adjusted weights, which are either the weights
...
#'
#' @param xcoord Vector of x-coordinates for location, which are either the
...
#'
#' @param ycoord Vector of y-coordinates for location, which are either the
#'   y-coordinates for a single-stage sample or the stage two y-coordinates for
#'   a two-stage sample.  This variable can be input directly or as a formula
#'   and must be supplied either as this argument or in the design data frame
#'   when argument vartype is set to "Local".  The default is NULL.
#'
#' @param stratum The stratum codes.  This variable can be input directly or
...
#'   The default is NULL.
#'
#' @param wgt1 Vector of final adjusted stage one weights.  This variable can
#'   be input directly or as a formula.  The default is NULL.
#'
#' @param xcoord1 Vector of  the stage one x-coordinates for location.  This
#'   variable can be input directly or as a formula.  The default is NULL.
#'
#' @param ycoord1 Vector of the stage one y-coordinates for location.  This
#'   variable can be input directly or as a formula.  The default is NULL.
#'
...
#'   as a formula. The default is NULL.
#'
#' @param swgt1 Vector of  the stage one size-weight for each site.  This
#'   variable can be input directly or as a formula.  The default is NULL.
#'
...
#'
#' @return  List of class spsurvey.analysis.  Only those sites indicated by
...
spsurvey.analysis <- function(sites = NULL, subpop = NULL, design = NULL,
   ...
   var.sigma = NULL, xcoord = NULL, ycoord = NULL, stratum = NULL,
   cluster = NULL, wgt1 = NULL, xcoord1 = NULL, ycoord1 = NULL, popsize = NULL,
