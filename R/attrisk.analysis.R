...
#'
#' @param design Data frame consisting of design variables.  Variables should be
#'   named as follows:
#'     \describe{
...
#'     } 
#'
#' @param data.ar Data frame of categorical response and stressor variables,
...
#'
#' @param response.var Character vector providing names of columns in argument
...
#'
#' @param stressor.var Character vector providing names of columns in argument
...
#'   response.var.
#'
#' @param response.levels List providing the category values (levels) for each
...
#'
#' @param stressor.levels List providing the category values (levels) for each
...
#'
#' @return A data frame of attributable risk estimates for all combinations of
