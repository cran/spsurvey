...
#'     } 
#'
#' @param data.rr Data frame of categorical response and stressor variables,
...
#'
#' @param   stressor.var Character vector providing names of columns in
...
#'
#' @return Data frame of relative risk estimates for all combinations of
