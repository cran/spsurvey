################################################################################
# Function: total_est (not exported)
# Programmer: Tom Kincaid
# Date: October 25, 2021
#
#' Total Estimates for Probability Survey Data
#'
#' This function calculates total estimates using the svytotal function in the
#' survey package.  Upper and lower confidence bounds also are estimated.
#'
#' @param totalsum Data frame containing estimates.
#'
...
#'   \describe{
#'     \item{\code{totalsum}}{data frame containing the percentile estimates}
...
#'       design object}
#'     \item{\code{total_localmean}}{organizes input and output for
