...
#'
#' @param dg Vector of the values of the derivative of the deconvolution
#'   function g(.) evaluated at val for the response value for each site.
#'
...
#'   stratied, where TRUE = a stratified sample and FALSE = not a stratified
#'   sample.
#'
