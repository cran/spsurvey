...
#' total, mean, variance, and standard deviation of a response variable. Either
...
#'
#' @param var.est The variance estimate.
#'
#' @param sd.est The standard deviation estimate.
#'
