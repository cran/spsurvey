...
#'
#' @param N.cluster Number of stage one sampling units in the resource, which
...
cat.analysis <- function(sites = NULL, subpop = NULL, design = NULL,
   data.cat = NULL, popsize = NULL, popcorrect = FALSE, pcfsize = NULL,
    N.cluster = NULL, stage1size = NULL, sizeweight = FALSE, vartype = "Local",
    conf = 95, spsurvey.obj = NULL) {
